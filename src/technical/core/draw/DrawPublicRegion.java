...
public class DrawPublicRegion extends DrawBlock
{
    ...
    public DrawPublicRegion(String suffix){
        this.bundle = suffix;
    }

    public DrawPublicRegion(String suffix, float rotateSpeed){
        this.bundle = suffix;
        this.rotateSpeed = rotateSpeed;
    }

    public DrawPublicRegion(String suffix, float rotateSpeed, boolean spinSprite){
        this.bundle = suffix;
        this.spinSprite = spinSprite;
        this.rotateSpeed = rotateSpeed;
    }

    public DrawPublicRegion(){
    }
    ...
    public void load(Block block){
        region = Core.atlas.find(Technical.name + "-" + bundle);
    }
}
