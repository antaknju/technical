...
import technical.core.dialog.Talk;
...
//    }
    ...
    public static String message(SectorPreset sector, Talk talk, String text)
    {
        return get(build("dialog", sector.name, talk.name, text));
    }

    public static String sender(String text)
    {
        return get(build("dialog", "sender", text));
    }

    public static String techtree(Planet planet)
    {
        return get(build("techtree", planet.name));
    }
