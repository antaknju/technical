...
public class Debugger
{
        ...
        Core.input.addProcessor(new InputProcessor()
        {
            ...
            public boolean keyDown(KeyCode key)
            {
                if(key == KeyCode.f2)
                {
                    ...
                    rprint("Changed Debugger State: @", enabled);
        ...
        Core.input.addProcessor(new InputProcessor()
        {
            ...
            public boolean keyDown(KeyCode key)
            {
                ...
                if(key == KeyCode.f3 && enabled)
                {
                    ...
                    print("Changed Player Team To: @", Vars.player.team());
    ...
    public static void rprint(String text, Object... args)
    {
        System.out.println(Log.format("&p&fb[T]&fr " + text + "&fr", args));
    }

    public static void rprint(Object object)
    {
        rprint(String.valueOf(object), empty_args);
    }
